...
Route::group(['middleware' => ['role:guest']], function () {
    Route::controller(GuestController::class)->group(function () {
        Route::get('guest/upload_foto', function () {
            return view('guest.upload_foto');
        })->name('guest.upload_foto');
...
Route::get('/madin-data/{id}/edit', [MadinController::class, 'dataEdit'])->name('madin.edit');
...
Route::get('/madin-rombel', [MadinController::class, 'rombel']);
Route::get('/madin-rombel/{id}/edit', [MadinController::class, 'rombelEdit'])->name('madin-rombel.edit');
Route::get('/madin-rombel/{id}/show', [MadinController::class, 'rombelShow'])->name('madin-rombel.show');
